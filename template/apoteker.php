        ...
        <div class="col-2">
          ...
          <div class="navbar navbar-expand sticky-top sidebar d-flex flex-column align-items-stretch w-100">
            ...
            <ul class="navbar-nav flex-column mb-auto w-100">
              ...
              <li class="nav-item mt-2 <?=@ $_GET['halaman'] == 'stok-kadaluwarsa'? 'active-link': '' ?>">
                <a href="?halaman=stok-kadaluwarsa" class="nav-link text-light">
            ...
            <div class="d-flex p-3 w-100 align-items-center">
              <img src="img/avatar-apoteker.png" alt="" width="32" height="32" class="rounded-circle me-2" />
              <p class="text-white">Apoteker</p>
